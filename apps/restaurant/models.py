...
from apps.abstracts.models import DateAbstractModel

# Create your models here.
class User(AbstractSoftDeleteModel):
...
class Restaurant(DateAbstractModel):
    name = models.CharField(max_length=255)
...
class Address(AbstractSoftDeleteModel):
...
class MenuItem(DateAbstractModel):
...
class Order(AbstractSoftDeleteModel):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    menu_item = models.ForeignKey(MenuItem, on_delete=models.CASCADE)
...
class OrderPromo(AbstractSoftDeleteModel):
